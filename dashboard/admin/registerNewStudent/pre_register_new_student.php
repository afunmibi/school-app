...
$message = "<div class='alert alert-success'>✅ <strong>Pre-Registration Successful!</strong><br>" .
...
"<strong>Temporary Password:</strong> " . $plain_password . "<br><br>" .
"⚠️ Kindly make a payment of <strong>N" . number_format($payment_amount, 2) . "</strong> to <strong>GTBank Account: 0000000000, Felix Adewale</strong>.<br>" .
"Return to the portal after 10 minutes to complete your registration.<br>" .
