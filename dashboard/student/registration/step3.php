...
require_once '../../../vendor/autoload.php'; // Adjust path to Dompdf
use Dompdf\Dompdf;
...
ini_set('error_log', '../../../logs/registration_errors.log'); // Ensure this path is writable

// Ensure student is logged in
$unique_id = $_SESSION['student_unique_id'] ?? null;
if (!$unique_id) {
    $message = "<div class='alert alert-danger'>Please log in to continue. <a href='login.php' class='alert-link'>Log In</a></div>";
    error_log("Step 3: No student_unique_id found in session.");
